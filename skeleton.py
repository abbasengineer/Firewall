...
class final_topo(Topo):
  def build(self):
    ...
    '''
    self.addLink(s1,h1, port1=8, port2=1)
    self.addLink(s2,h2, port1=8, port2=1)
    self.addLink(s3,h3, port1=8, port2=1)
    self.addLink(s4,h4, port1=8, port2=1)
    self.addLink(s5,h5, port1=8, port2=1)
